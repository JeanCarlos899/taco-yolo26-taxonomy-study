...
A Tabela~\ref{tab:hierarchy} responde a uma pergunta diferente: o que acontece quando as \emph{mesmas} caixas e confianças produzidas pelo modelo Fine são julgadas com menos detalhe semântico? Ao aceitar a macroclasse de material, AP$_{50}$ passou de $0{,}103$ para $0{,}171$; ao ignorar classes, chegou a $0{,}466$. Como não há novo treinamento nesta análise, o ganho mostra quanto da penalização depende dos rótulos, embora a mudança da macro-média impeça interpretá-lo como contagem pura de erros semânticos. A Tabela~\ref{tab:bootstrap} informa se esse efeito se repete entre sementes.
