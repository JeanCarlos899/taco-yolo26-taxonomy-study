...
\begin{equation}
  ...
  \label{eq:bootstrap}
\end{equation}
Fizemos 2.000 reamostragens, com os mesmos índices nos dois lados. O bootstrap usa as predições da semente 42; as demais análises agregam três sementes. Para cauda longa, a frequência é calculada apenas no treino: rara ($n\leq19$), média ($20\leq n\leq100$) e frequente ($n>100$). Métricas por classe incluem somente rótulos presentes no teste fixo.
