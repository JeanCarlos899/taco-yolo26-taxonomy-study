...
\begin{frame}{Como o TACO representa cada objeto}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.205\textwidth}
      ...
      \includegraphics[height=3.65cm,width=\linewidth,keepaspectratio]{assets/taco_original_example.png}
    \end{column}
    \begin{column}{0.205\textwidth}
      \centering{\color{ufpidark}\bfseries Segmentação Fine}\par\vspace{0.10cm}
      \includegraphics[height=3.65cm,width=\linewidth,keepaspectratio]{assets/taco_segmentation_example.png}
    \end{column}
    \begin{column}{0.205\textwidth}
      \centering{\color{ufpidark}\bfseries Caixas COCO}\par\vspace{0.10cm}
      \includegraphics[height=3.65cm,width=\linewidth,keepaspectratio]{assets/taco_bbox_example.png}
    \end{column}
    \begin{column}{0.31\textwidth}
      ...
      Drink can $\rightarrow$ Metal $\rightarrow$ Litter}
      \vspace{0.18cm}

      {\color{muted}\fontsize{9.5}{12}\selectfont 13 objetos e 10 classes Fine. O YOLO utiliza as caixas; as máscaras documentam a anotação original.}
    \end{column}
  \end{columns}
\end{frame}
